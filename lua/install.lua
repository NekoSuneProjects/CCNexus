...
print('CCNexus Installer')
print('=================')
print('This will install the CCNexus agent and startup entry.')
print('')
...
cfg.write(textutils.serializeJSON({ server = server, deviceId = data.deviceId, token = data.deviceToken, label = label, kind = kind }))
cfg.close()
